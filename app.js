...
const items = document.querySelectorAll(".profile-text,.songlistwrap,.feature-content,.logo,.container,.song-list-title,.navbar-container,.sidebar,.left-menu-icon,.toggle,.songlistimg,.songlistitem,.songlistdesc");
